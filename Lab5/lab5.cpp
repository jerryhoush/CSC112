...
* @version 1.0 
*
* @brief   CSC 112, Lab 5. This lab adds three new *          functions to the mix. One function allows the *          user to add a second audio file to play at the *          same time as the first. The second shortens the *          audio file array in half. The third doubles the *          size of the array. 
*
