...
*	   the search function in order to speed up the program and make it more efficient. If extra space is needed,
*	   the size of the array can be modified in order to add space. 
*
